...
**Inherits:** COMMON PROTOCOL rev-1.4 `docs/f2g_phase_b_power_annex_common.md` @ geospec `3b0c355`, sha256 `6bde55e84c8845fd9967628bf1170e063faf2f26a50849661630838b87ffa768` (calendar-frame lane sec 6 NORMATIVE for all new estimation) (generator incl. γ=0.05 shared calendar factor, geometry, `B1A` substreams with the frozen-amendment seed root, tiers, certification/stopping, frontier, no-power route, equivalence gate — all normative).
