...
**Family under test:** frozen AMENDMENT 1 §A1 exactly (freeze `F2G-PB-A1-R3-FREEZE-CODEX-20260820T1325Z`, authority `7c3ca7b`, LF sha `f3d0830b38869d8b6f0b03d113d45ae0f111e8645bd4a2934582b21e48e909e8`): statistic/effect class per Amendment 1 sec A1; TEMPORAL FRAME AND TRANSFORMS SUPERSEDED BY FROZEN AMENDMENT 2: eleven equal 12-CALENDAR-POSITION blocks over the 132-position shared calendar, 72/60 baseline/evaluation split (6/5 block-slots), ONE common `S_11` action per draw incl. identity, frozen calendar-position window rule (7 consecutive positions, >=4/7 finite), typed absences never compressed; family-level `CANNOT_DETERMINE_FAMILY_SCORABILITY` withholding; add-one p, 9,999 draws, frozen valid-draw floor.
