...
def run_hualien_backtest():
    print("="*80)
    print("TAIWAN (HUALIEN 2024) BACKTEST")
    print("="*80)
    
    region = 'hualien'
    # Event: Apr 3, 2024 M7.4
    start_date = datetime(2024, 3, 20)
    end_date = datetime(2024, 4, 10)
    
    # Cache directory for this backtest
    cache_dir = Path(__file__).parent / "data" / "backtest" / "hualien_2024" / "gps_full"
    ...
    while current_date <= end_date:
        ...
        try:
            ...
            if lg_result and lg_result.n_stations >= 3:
                ...
                # Baseline - Taiwan is extremely active
                baseline = 0.5 
    ...
    # Save results
    output_file = Path(__file__).parent / "data" / "backtest" / "hualien_results.json"
