...
def run_kumamoto_backtest():
    print("="*80)
    print("JAPAN (KUMAMOTO 2016) BACKTEST")
    print("="*80)
    
    region = 'kumamoto'
    # Foreshock M6.2: Apr 14
    # Mainshock M7.0: Apr 16
    start_date = datetime(2016, 4, 1)
    end_date = datetime(2016, 4, 25)
    
    # Cache directory for this backtest
    cache_dir = Path(__file__).parent / "data" / "backtest" / "kumamoto_2016" / "gps_full"
    ...
    while current_date <= end_date:
        ...
        try:
            ...
            if lg_result and lg_result.n_stations >= 3:
                ...
                # Baseline estimation - Japan (GEONET) is very dense and precise
                baseline = 0.5 
    ...
    # Save results
    output_file = Path(__file__).parent / "data" / "backtest" / "kumamoto_results.json"
